...
> AFTER EVERY ACTION OR RESPONSE, THE AGENT MUST CALL MCP interactive_feedback — WITHOUT EXCEPTION — AND MUST NOT COMPLETE OR END THE PROCESS UNTIL USER FEEDBACK IS EMPTY.
